...
echo "Running training script"
  ...
  --prompt "Portrait of a royal cyberpunk fantasy character, elegant noble face, futuristic crown, glowing neon ornaments, luxurious sci-fi costume, majestic fantasy aesthetics, colorful hair, dramatic cinematic lighting, highly detailed facial features, sharp focus, beautiful stylized portrait" \
  --save_path "work_dirs/royal_cyberpunk_sds" \
